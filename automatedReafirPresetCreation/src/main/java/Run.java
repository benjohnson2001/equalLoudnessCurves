...
public class Run {
   ...
   public static void main(String[] args) throws Exception {
      ...
      Pattern currentTrackPattern = new Pattern(Run.class.getResource("currentTrack.png"));
      Pattern closeButtonPattern = new Pattern(Run.class.getResource("closeButton.png"));
      Pattern base1Pattern = new Pattern(Run.class.getResource("base1.png"));
      Pattern base2Pattern = new Pattern(Run.class.getResource("base2.png"));
      Pattern plus68Pattern = new Pattern(Run.class.getResource("plus68.png"));
      Pattern plusZeroPattern = new Pattern(Run.class.getResource("plusZero.png"));
      Pattern insertPointPattern = new Pattern(Run.class.getResource("insertPoint.png"));
      Pattern setPattern = new Pattern(Run.class.getResource("set.png"));
      Pattern frequencyPattern = new Pattern(Run.class.getResource("frequency.png"));
      Pattern gainPattern = new Pattern(Run.class.getResource("gain.png"));
      Pattern okButtonPattern = new Pattern(Run.class.getResource("okButton.png"));
      Pattern plusButtonPattern = new Pattern(Run.class.getResource("plusButton.png"));
      Pattern exportPatchPattern = new Pattern(Run.class.getResource("exportPatch.png"));
      Pattern savePresetPattern = new Pattern(Run.class.getResource("savePreset.png"));
      Pattern presetNamePattern = new Pattern(Run.class.getResource("presetName.png"));
      Pattern saveAsPattern = new Pattern(Run.class.getResource("saveAs.png"));
      Pattern savePatchButtonPattern = new Pattern(Run.class.getResource("savePatchButton.png"));
      Pattern fiftyPattern = new Pattern(Run.class.getResource("fifty.png"));
      Pattern removeFxPattern = new Pattern(Run.class.getResource("removeFx.png"));
